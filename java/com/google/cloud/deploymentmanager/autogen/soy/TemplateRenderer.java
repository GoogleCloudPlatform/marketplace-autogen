...
import com.google.template.soy.jbcsrc.api.LegacySoyJavaStringCaller; // copybara:strip(compile_error)
...
public final class TemplateRenderer {
  ...
  public static class FileSet {
    ...
    @LegacySoyJavaStringCaller // copybara:strip(compile_error)
